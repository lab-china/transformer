...
_TRAIN_DATA_SOURCES = [
    {
        "url": "",
        "input": "train_ja_1.csv",
        "target": "train_en_1.csv",
    },
    {
        "url": "",
        "input": "train_ja_2.csv",
        "target": "train_en_2.csv",
    },
    {
        "url": "",
        "input": "train_ja_3.csv",
        "target": "train_en_3.csv",
    },
    {
        "url": "",
        "input": "train_ja_4.csv",
        "target": "train_en_4.csv",
    },
]
...
def main(unused_argv):
  ...
  train_files = get_raw_files(FLAGS.raw_dir, _TEST_DATA_SOURCES)
...
def define_data_download_flags():
  ...
  flags.DEFINE_string(
      name="data_dir", short_name="dd", default="D:/02_AIPJ/00_data/0202/transformer/00_data_oper/otput",
      help=flags_core.help_wrap(
          "Directory for where the translate_ende_wmt32k dataset is saved."))
  flags.DEFINE_string(
      name="raw_dir", short_name="rd", default="D:/02_AIPJ/00_data/0202/transformer/00_data_oper/input",
      help=flags_core.help_wrap(
