...
PARAMS_MAP = {
    ...
    'small': model_params.SMALL_PARAMS,
...
def get_model_params(param_set, num_gpus):
  ...
  if num_gpus > 1:
    ...
    elif param_set == 'small':
      return model_params.SMALL_MULTI_GPU_PARAMS.copy()
    elif param_set == 'tiny':
      return model_params.TINY_MULTI_GPU_PARAMS.copy()
    else:
...
def define_transformer_flags():
  ...
  flags.DEFINE_integer(
      name='train_steps', short_name='ts', default=train_steps,#300000,
      help=flags_core.help_wrap('The number of steps used to train.'))
  flags.DEFINE_integer(
      name='steps_between_evals', short_name='sbe', default=steps_between_evals,#5000,
      help=flags_core.help_wrap(
          'The Number of training steps to run between evaluations. This is '
          'used if --train_steps is defined.'))
  flags.DEFINE_boolean(
      name='enable_time_history', default= enable_time_history,#True,
  ...
  flags.DEFINE_enum(
      name='param_set', short_name='mp', default=param_set,#'big',
  ...
  flags.DEFINE_integer(
      name='max_length', short_name='ml', default=max_length,#256,
      help=flags_core.help_wrap(
  ...
  flags.DEFINE_string(
      name='bleu_source', short_name='bls', default=bleu_source,#None,
      help=flags_core.help_wrap(
          'Path to source file containing text translate when calculating the '
          'official BLEU score. Both --bleu_source and --bleu_ref must be set. '
          ))
  flags.DEFINE_string(
      name='bleu_ref', short_name='blr', default=bleu_ref,#None,
      help=flags_core.help_wrap(
          'Path to source file containing text translate when calculating the '
          'official BLEU score. Both --bleu_source and --bleu_ref must be set. '
          ))
  flags.DEFINE_string(
      name='vocab_file', short_name='vf', default=vocab_file,#None,
      help=flags_core.help_wrap(
  ...
  flags_core.set_defaults(data_dir=data_dir,#'/tmp/translate_ende',
                          model_dir=model_dir,#'/tmp/transformer_model',
