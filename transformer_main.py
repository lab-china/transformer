...
# flags.DEFINE_string(name="data_dir", short_name="data_dir", default=DATA_DIR,help=flags_core.help_wrap("help"))
# flags.DEFINE_string(name="model_dir", short_name="model_dir", default=MODEL_DIR,help=flags_core.help_wrap("help"))
# flags.DEFINE_string(name="vocab_file", short_name="vocab_file", default=vocab_file,help=flags_core.help_wrap("help"))
# flags.DEFINE_string(name="param_set", short_name="param_set", default=param_set,help=flags_core.help_wrap("help"))
# flags.DEFINE_integer(name="train_steps", short_name="train_steps", default=100000,help=flags_core.help_wrap("help"))
# flags.DEFINE_integer(name="steps_between_evals", short_name="steps_between_evals", default=5000,help=flags_core.help_wrap("help"))
# flags.DEFINE_integer(name="batch_size", short_name="batch_size", default=4096,help=flags_core.help_wrap("help"))
# flags.DEFINE_integer(name="max_length", short_name="max_length", default=64,help=flags_core.help_wrap("help"))
# flags.DEFINE_string(name="bleu_source", short_name="bleu_source", default=bleu_source,help=flags_core.help_wrap("help"))
# flags.DEFINE_string(name="bleu_ref", short_name="bleu_ref", default=bleu_ref,help=flags_core.help_wrap("help"))
# flags.DEFINE_integer(name="num_gpus", short_name="num_gpus", default=0,help=flags_core.help_wrap("help"))
# flags.DEFINE_bool(name="enable_time_history", short_name="enable_time_history", default=False,help=flags_core.help_wrap("help"))
