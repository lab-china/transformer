...
BASE_PARAMS = defaultdict(
    ...
    vocab_size=55993,  # Number of tokens defined in the vocabulary file.
...
SMALL_MULTI_GPU_PARAMS = SMALL_PARAMS.copy()
SMALL_MULTI_GPU_PARAMS.update(
    learning_rate_warmup_steps=8000
)
...
TINY_PARAMS.update(
    default_batch_size=128,#1024,
    default_batch_size_tpu=128,#1024,
    hidden_size=8,#32,
    max_length=32,
    num_heads=4,
    filter_size=16,#256,
...
TINY_MULTI_GPU_PARAMS = TINY_PARAMS.copy()
TINY_MULTI_GPU_PARAMS.update(
    learning_rate_warmup_steps=8000
)